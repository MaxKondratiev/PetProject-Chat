...
let fullImageView = AddPhotoView()
    ...
    let welcomeLabel = UILabel(text: "Set up profile", font: .avenirFont())
    ...
    let fullNameTextField = OneLineTextField(font: .avenirFont())
    let aboutMeTextField = OneLineTextField(font: .avenirFont())
